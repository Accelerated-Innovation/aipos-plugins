...
- Exploration planning requires a live Product Definition Graph read connection.
...
- Solution framing reads the same graph when it is connected and falls back to the PM's
...
- Use Python 3.11+ for bundled scripts. Install the requirements belonging to the
  script you run: [map-render](skills/aipos-map-render/scripts/requirements.txt)

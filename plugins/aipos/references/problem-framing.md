...
- **Lock personas once confirmed.** They are inherited by `aipos-feature-create` and every feature under this epic. Changing them later invalidates downstream work, so confirm deliberately.

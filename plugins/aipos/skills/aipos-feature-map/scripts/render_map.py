...
Inputs (see references/ingestion-contract.md for the full schema):
    ...
    scores.json     optional   aipos-feature-refine batch verdicts, keyed by feature key
    sizing.json     optional   aipos-feature-slice verdicts AFTER compute_size.py --
...
def render(feats, scores, sizing, cfg, workflow=None):
    ...
    if sizing:
        ...
        sizenote = (
            ...
            f'Judgments by aipos-feature-slice; all arithmetic by compute_size.py. '

...
- **Not a quality judgment.** Quality is `aipos-feature-refine`'s rubric. A beautifully written scenario can be Large; a sloppy one can be Small. A feature can score 9/10 on quality and still carry three Large scenarios — those are different findings, and both matter.

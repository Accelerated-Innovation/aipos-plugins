...
This rubric produces a recommendation. The Development Token that authorizes AI-assisted coding is issued by `aipos-feature-readiness` against the feature package in the repo, using its stricter 12-dimension rubric. Refinement judges whether the team understands the feature; readiness judges whether the repo can execute it.

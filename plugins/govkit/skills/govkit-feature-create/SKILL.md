...
If yes, draft the mitigation text and add `@nfr-pii` coverage to the Gherkin. If a privacy scenario is missing, add it — this is one of `govkit-feature-readiness`'s named blockers.

...
Then add `@nfr-pii` scenario coverage to the Gherkin. A privacy claim with no scenario proving it is a paragraph, not a control — and a missing privacy path is a named blocker at the readiness gate.
